...
def adapt_for_ui(
    ...
    return {
        ...
        "connectors": deepseek_analysis.get("connectors", []),
        "discourse_markers": deepseek_analysis.get("connectors", []),
        "phrasal_collocations": [],
        "sentence_patterns": deepseek_analysis.get("sentence_patterns", []),
